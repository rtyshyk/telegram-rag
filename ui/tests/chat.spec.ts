...
test.describe('Chat Interface', () => {
  ...
  test('should show empty state initially', async ({ page }) => {
    ...
    await expect(page.locator('text=Ask me anything about your documents')).toBeVisible();
  ...
  test('should send message and show typing indicator', async ({ page }) => {
    ...
    await expect(page.locator('.bg-blue-600').locator(`text=${message}`)).toBeVisible();
  ...
  test('should handle Enter key to send message', async ({ page }) => {
    ...
    await expect(page.locator('.bg-blue-600').locator('text=Test message')).toBeVisible();
  });
  ...
  test('should select different models', async ({ page }) => {
    ...
    await expect(page.locator('button:has(.bg-green-500)').locator('text=GPT-4')).toBeVisible();
  ...
  test('should handle long messages', async ({ page }) => {
    ...
    await expect(page.locator(`.bg-blue-600:has-text("${longMessage.substring(0, 50)}")`)).toBeVisible();
  });
});
