...
test.describe('Navigation and Routing', () => {
  test.skip('should redirect to login when accessing app without authentication', async ({ page }) => {
...
test.describe('Error Handling', () => {
  test('should handle network timeouts', async ({ page }) => {
    ...
    await expect(page.locator('.text-red-700')).toContainText('request timeout', { timeout: 12000 });
  });
  ...
  test('should handle server errors', async ({ page }) => {
    ...
    await expect(page.locator('.text-red-700')).toContainText('connection error');
  });
...
test.describe('Security', () => {
  ...
  test('should have proper form security attributes', async ({ page }) => {
    ...
    await expect(page.locator('input[type="text"]')).toHaveAttribute('autocomplete', 'username');
