        ...
        getReader: () => ({
          read: vi.fn()
            .mockResolvedValueOnce({
              ...
              value: new TextEncoder().encode('data: {"type":"content","content":"Test"}\n\n')
            })
            .mockResolvedValueOnce({
              done: true,
              value: null
        ...
        getReader: () => ({
          read: vi.fn()
            .mockResolvedValueOnce({
              ...
              value: new TextEncoder().encode('data: {"type":"search","content":"Searching..."}\n\n')
            })
            .mockResolvedValueOnce({
              done: false,
            ...
            .mockResolvedValueOnce({
              ...
              value: new TextEncoder().encode('data: {"type":"end","usage":{"prompt_tokens":10,"completion_tokens":5,"total_tokens":15}}\n\n')
            })
            .mockResolvedValueOnce({
              done: true,
              value: null
