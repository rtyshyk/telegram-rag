...
def _make_message(**kwargs):
	defaults = {
		'id': 1,
		'text': 'Hello world',
		'sender': type('User', (), {'first_name': 'John', 'last_name': 'Doe', 'username': 'jdoe'})(),
		'date': datetime.now(),
		'edit_date': None,
...
def test_extract_message_data_basic():
	...
	try:
		msg = _make_message()
		chat_entity = type('Chat', (), {'megagroup': False, 'channel': False, 'user_id': 10})()
...
def test_extract_message_data_forward():
	...
	real_settings.telethon_stub = True
	try:
		forward_sender = type('User', (), {'first_name': 'Alice', 'last_name': '', 'username': 'alice'})()
		forward = type('Fwd', (), {'from_name': None, 'sender': forward_sender})()
		msg = _make_message(forward=forward)
		chat_entity = type('Chat', (), {'megagroup': True, 'channel': False, 'user_id': None})()
		data = wrapper.extract_message_data(msg, chat_entity)
	finally:
		real_settings.telethon_stub = original
