...
class VespaClient:
        ...
        for attempt in range(3):
            try:
                ...
                if response.status_code in [200, 201]:
                    ...
                    logger.warning(f"Vespa feed failed: {response.status_code} {response.text}")
    ...
    async def delete_document(self, doc_id: str) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 404]:  # 404 is OK - already deleted
                ...
                logger.warning(f"Vespa delete failed: {response.status_code} {response.text}")
                return False
    ...
    async def health_check(self) -> bool:
        ...
        try:
            response = await self.client.get(f"{settings.vespa_endpoint.replace(':8080', ':19071')}/ApplicationStatus")
