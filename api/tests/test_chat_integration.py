...
class TestChatAPI:
    ...
    async def test_chat_empty_query_validation(self):
        ...
        async with AsyncClient(app=app, base_url="http://test") as client:
            ...
            assert response.status_code in [
                400,
                401,
            ]  # 400 for validation, 401 for auth
    ...
    async def test_chat_with_filters(self):
        ...
        payload = {
            ...
            "k": 5,
            "filters": {"chat_ids": ["-123456"], "date_from": "2025-08-01"},
            "model_id": "gpt-5",
        }
    ...
    async def test_chat_with_history(self):
        ...
        payload = {
            ...
            "history": [
                ...
                {
                    "role": "assistant",
                    "content": "Based on your messages, the connection string is postgres://...",
                },
...
class TestChatModels:
    ...
    def test_chat_request_with_history(self):
        ...
        request = ChatRequest(q="Follow-up question", history=history)
    ...
    def test_chat_usage_with_cost(self):
        ...
        usage = ChatUsage(
            prompt_tokens=1000, completion_tokens=500, total_tokens=1500, cost_usd=0.025
        )
